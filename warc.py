...
if __name__=="__main__":
    ...
    html_prase = get_html_warc('https://commoncrawl.s3.amazonaws.com/crawl-data/CC-MAIN-2020-40/segments/1600400187354.1/warc/CC-MAIN-20200918061627-20200918091627-00000.warc.gz')
    #print(html_prase)
